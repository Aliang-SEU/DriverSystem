...
//    cv::putText(img, txt, cv::Point(60, 20), 0.5, 0.5, cv::Scalar(255, 0, 0));
//    stringstream ss1;
//    ss1 << eav[1];
//    string txt1 = "Yaw: " + ss1.str();
//    cv::putText(img, txt1, cv::Point(60, 40), 0.5, 0.5, cv::Scalar(255, 0, 0));
//    stringstream ss2;
//    ss2 << eav[2];
//    string txt2 = "Roll: " + ss2.str();
//    cv::putText(img, txt2, cv::Point(60, 60), 0.5, 0.5, cv::Scalar(255, 0, 0));
}
